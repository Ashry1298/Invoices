        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="">
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                <label> {{__('main.username')}} <span class="tx-danger">*</span></label>
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                <label>{{__('main.email')}}<span class="tx-danger">*</span></label>
                                <input class="form-control form-control-sm mg-b-20"
                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            <label> {{__('main.pass')}}<span class="tx-danger">*</span></label>
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                                name="password" required="" type="password">
                        </div>

                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            <label> {{__('main.passconf')}} <span class="tx-danger">*</span></label>
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-lg-6">
                            ...
                            <select name="status" id="select-beast" class="form-control  nice-select  custom-select">
                                <option value="مفعل">{{__('main.active')}}</option>
                                <option value="غير مفعل"> {{__('main.unactive')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-md-12">
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="role_name">{{__('main.userperm')}} </label>
