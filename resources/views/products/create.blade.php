...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{__('main.addproduct')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
    ...
    <form method="POST" action="{{ route('products.store') }}">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="exampleFormControlSelect1" name="section_id">
                <option selected disabled>{{__('main.choosesection')}}</option>
