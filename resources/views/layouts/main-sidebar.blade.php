    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" {{-- {{ URL::asset('assets/img/faces/icon.png') }} --}}
                        src="{{ asset('imgs/icon.png') }}"><span class="avatar-status profile-status bg-green"></span>
                </div>
                <div class="user-info">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">{{__('main.invPro')}}</li>
            <li class="slide">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">{{__('main.inv')}}</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('القائمه الكامله للفواتير')
                            <li>
                        ...
                        @can('الفواتير المدفوعه')
                            <li><a class="slide-item" href="{{ route('invoices.paid') }}"> {{__('main.paidInv')}}</a></li>
                        @endcan
                        @can('الفواتير غير المدفوعه')
                            <li><a class="slide-item" href="{{ route('invoices.unPaid') }}"> 
                                {{__('main.unPaidInv')}} </a>
                            </li>
                        @endcan
                        @can('الفواتير المدفوعه جزئيا')
                            <li><a class="slide-item" href="{{ route('invoices.partial') }}"> 
                                {{__('main.partialInv')}} </a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('archieve.index') }}">  {{__('main.archieve')}}
                                </a>
                            </li>
                        @endcan
                    </ul>
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">{{__('main.reports')}}</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('تقارير الفواتير')
                            <li><a class="slide-item" href="{{ route('reports.invoices') }}"> {{ __('main.Invrep') }}</a></li>
                        @endcan
                        @can('تقارير العملاء')
                            <li><a class="slide-item" href="{{ route('reports.Customers') }}">{{__('main.custrep')}}</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                                      </svg><span class="side-menu__label">{{__('main.users')}}</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('قائمه المستخدمين')
                            <li><a class="slide-item" href="{{ route('users.index') }}"> {{__('main.userslist')}} </a></li>
                        @endcan

                        <li><a class="slide-item" href="{{ route('roles.index') }}">{{__('main.usersperm')}} </a></li>
                    </ul>
                </li>
            @endcan
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="#"><svg
                        ...
                        </svg><span class="side-menu__label">{{__('main.invcontroll')}}</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ route('sections.index') }}">{{__('main.sections')}}</a></li>
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ route('products.index') }}"> {{__('main.products')}} </a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
