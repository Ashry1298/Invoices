        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('home') }}"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    </svg><span class="side-menu__label">الصفحه الرئيسيه</span><span>
                        @can('الفواتير')
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('القائمه الكامله للفواتير')
                            <li>
                                <a class="slide-item" href="{{ route('invoices.index') }}">القائمه الكامله
                                    للفواتير</a>
                            </li>
                        @endcan
                        ...
                        @can('الفواتير المدفوعه')
                            ...
                            <li><a class="slide-item" href="{{ route('invoices.unPaid') }}">الفواتير غير
                                    المدفوعه</a>
                            </li>
                        @endcan
                        @can('الفواتير غير المدفوعه')
                            <li><a class="slide-item" href="{{ route('invoices.partial') }}">الفواتير المدفوعه
                                    جزئيا</a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('archieve.index') }}">ارشيف الفواتير
                                </a>
                            </li>
                        @endcan
                    </ul>
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('تقارير العملاء')
                            <li><a class="slide-item" href="{{ route('reports.Customers') }}">تقارير العملاء</a>
                            </li>
                        @endcan
                    </ul>
                </li>
